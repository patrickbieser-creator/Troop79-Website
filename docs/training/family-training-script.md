...
▸ [SCREEN: browser closed or a blank tab. Then type troop-79.com and press enter.]

Hi — I'm going to walk you through the Troop 79 website.
...
You just need this address.

Troop dash seven nine dot com.

Let me show you what's here, and how you'll actually use it.

---

## 2 — The front page

▸ [SCREEN: home page, full view. Scroll slowly through the hero and the sidebar.]
...
a campout, a fundraiser, a service project.

▸ [SCREEN: point at the hero headline, then the "Details & Signup" link.]

Click the headline, or click "Details and Signup,"
and you go straight to that event's own page.
...
▸ [SCREEN: click "News & Events" in the nav.]

The nav bar across the top is how you get everywhere.
...
▸ [SCREEN: click "Calendar" in the nav.]

This is the real calendar.
...
Click a category to show only that kind of thing.

▸ [SCREEN: click the "Past" tab, then back to "Upcoming."]

There's an Upcoming tab and a Past tab.
Past is genuinely useful when you're trying to remember
whether your scout was on that November campout.

▸ [SCREEN: point at and click the "Subscribe" button. Show the options.]

Now — this is the single most useful button on the site.

"Subscribe."

This puts the entire troop calendar
inside the calendar app already on your phone.

Not a copy. A live feed.
When we add a campout or move a meeting, it changes on your phone too.

▸ [SCREEN: hold on the subscribe panel for a beat.]

Do this once, tonight, and you will never again
be the family that showed up on the wrong Sunday.

---

## 5 — An event page

▸ [SCREEN: go back to Upcoming and click into a real campout or event with a signup.]
...
▸ [SCREEN: click Sign Up. Land on the signup page and show the gate.]

Signing up is its own page, on purpose.
...
For each person, you answer for them individually.
Coming, or not coming.

▸ [SCREEN: point at each field as you say it.]
...
Address, phone numbers, emails, schools,
graduation years, swim classification,
and a "things we should know" box —
allergies, medications, anything a leader should have
before a campout.

▸ [SCREEN: edit a field and submit the change.]

You edit it yourself. You don't email anybody.

▸ [SCREEN: show the pending-change state.]

Your change goes into a queue,
a leader approves it, and then it's live.
...
This is the part parents ask about most.

▸ [SCREEN: scroll the stats strip and rank distribution.]
...
▸ [SCREEN: click your own scout's name.]

Click a scout, and you get their clipboard.

▸ [SCREEN: scroll slowly down the scout detail page.]
...
▸ [SCREEN: point at the "Print PDF" button.]

And there's a Print button.
...
This is the answer to "how does my scout do this requirement at home?"

▸ [SCREEN: use the search box, then clear it.]

You can search it.

▸ [SCREEN: expand a rank in the accordion — Tenderfoot, for example.]

Or you can drill straight down through advancement.
Pick a rank. Pick a requirement.

▸ [SCREEN: click into a specific requirement page.]
...
There are also topic shelves for things
that don't map to a requirement — gear, camping skills, that sort of thing.

▸ [SCREEN: show the scout switcher, pick a scout.]

If you're signed in, you can pick your scout up here,
and the library marks what they've already finished.

▸ [SCREEN: on a requirement page, point at the "I did this" button.]

And when they *do* finish something at home,
there's an "I did this" button.
It sends the proof to a leader to review and sign off.

▸ [SCREEN: click "Suggest a Resource."]

Last thing — if you find something genuinely good,
"Suggest a Resource" sends it to us.
Everything gets reviewed before it goes up. Nothing publishes automatically.
...
Short version: come to a Sunday meeting.
There's nothing to fill out and nothing to buy first.

If you know a family who's curious, send them this page.
...
Everything's at troop dash seven nine dot com.

If something's wrong or something's confusing,
email us — the address is at the bottom of every page.
